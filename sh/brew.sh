...
linuxbrew=(gcc)
osxcask=(font-droidsansmono-nerd-font alfred slack mongodb-compass osxfuse hyper skype quitter sublime-text google-chrome 1password skype-for-business skitch spillo istat-menus iterm2 firefox appcleaner daisydisk vlc steam tunnelblick dropbox bartender little-snitch opera sizeup tuck)
