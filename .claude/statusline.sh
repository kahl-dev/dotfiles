...
# Custom Claude Code statusline - Created: 2025-08-26T12:42:08.896Z
...
if command -v jq >/dev/null 2>&1; then
  blocks_output=$(timeout 5 npx ccusage@latest blocks --json 2>/dev/null || timeout 5 ccusage blocks --json 2>/dev/null)
