...
# Sometimes it can happen when saving a document that you have to click first
...
# UNFORTUNATLY THIS IS NOT WORKING ANYMORE AND I CAN NOT FIND A WORKING SOLUTION
...
# Disable Ctrl+Space as input source switcher (conflicts with Neovim completion)
